...
# ===================== CONFIGURATION =====================
INPUT_IMAGES_DIR  = r"./dataset/original/images"           # ← CHANGE THIS to your images folder
INPUT_LABELS_DIR  = r"./dataset/original/labels"           # ← CHANGE THIS if you have labels
OUTPUT_IMAGES_DIR = r"./dataset/sharpen/images" # Where sharpened images will be saved
OUTPUT_LABELS_DIR = r"./dataset/sharpen/labels" # Labels will be copied here unchanged
