...
# ===================== CONFIGURATION =====================
INPUT_IMAGES_DIR  = r"../dataset/images"           # ← CHANGE THIS to your images folder
INPUT_LABELS_DIR  = r"../dataset/labels"           # ← CHANGE THIS if you have labels
OUTPUT_IMAGES_DIR = r"../dataset/sharpened_images" # Where sharpened images will be saved
OUTPUT_LABELS_DIR = r"../dataset/sharpened_labels" # Labels will be copied here unchanged
